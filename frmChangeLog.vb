Public Class frmChangeLog
    ...
    Private Sub frmChangeLog_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtChangeLog.Text = System.IO.File.ReadAllText("C:\Users\Scooby2\Documents\Personal Programming Challenges\Mal_Anime_Archive_Frm\Mal_Anime_Archive_Frm\changelog.txt")
