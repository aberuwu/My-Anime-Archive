...
Public Class frmSave
    ...
    Public Property ANIME_LIST_SAVE_JSON As String = ""
    ...
    Private Sub generateJson()
        ...
        With saveWindow
            ...
            .Title = "Save Anime List As JSON script"
            .ShowDialog()
        End With
        ...
        ANIME_LIST_SAVE_JSON = saveWindow.FileName

        Dim objWriter As New System.IO.StreamWriter(ANIME_LIST_SAVE_JSON)

        Dim jsonOut As String = JsonConvert.SerializeObject(frmMain.animeList)
        objWriter.WriteLine(jsonOut)
        objWriter.Close()
    End Sub
